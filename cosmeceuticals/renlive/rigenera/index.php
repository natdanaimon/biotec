    ...
    <div class="tm-middle uk-grid" data-uk-grid-match data-uk-grid-margin>
        ...
        <div class="tm-main uk-width-medium-1-1">
            ...
            <main class="tm-content">
                ...
                <div class="yoo-zoo cosmeceutici-uikit cosmeceutici-uikit-rigenera">
                        ...
                        <div class="uk-clearfix">
                            ...
                            foreach ($_data_type as $key => $value) {
                                ...
                                <div class="immagine-categoria">
                                    <img class="uk-align-medium-left" src="../../../manage/bio/uploads/cosme_type/<?= $_data_type[$key]['main_img']; ?>" title="<?= $_SESSION["rigenera"] ?>" alt="<?= $_SESSION["rigenera"] ?>" width="600" height="400"/>
                                </div>
                                <div class="immagine-logo-categoria"><img class="uk-align-medium-left" src="../../../manage/bio/uploads/cosme_type/<?= $_data_type[$key]['main_logo']; ?>" title="<?= $_SESSION["rigenera"] ?>" alt="<?= $_SESSION["rigenera"] ?>" width="600" height="400"/></div>
                            <?php } ?>				
                        </div>


                        <div class="contorno-titolo"><h1 class="uk-text-left"><?= $_SESSION["rigenera"] ?></h1></div>
                ...
                <div class="yoo-zoo cosmeceutici-uikit cosmeceutici-uikit-rigenera seconda-categoria">
