                    ...
                    <div class="sfondo-grigio">
                        <div class="uk-container uk-container-center">
                            ...
                            <div class="uk-grid data-uk-grid-margin">
                                ...
                                $_data = $controller->dataTable_type("M");
                            ...
                            <ul class="uk-pagination">
                                ...
                                if ($_data != NULL) {
                                    ...
                                    if (!$first) {
                                        $minus = $page - 1;
                                        echo "<li>";
                                        echo " <a href='news_magazine.php?page=1'>First</a>";
                                        echo "</li>";
                                        echo "<li>";
                                        echo "<a href='news_magazine.php?page=$minus'><<</a>";
                                        echo "</li>";
                                    }
                                    ...
                                    for ($i = 1; $i <= $rel; $i++) {
                                        ...
                                        if ($active == '') {
                                            echo "<li>";
                                            echo "<a href='news_magazine.php?page=$i'>$i</a>";
                                            echo "</li>";
                                        } else {
                                ...
                                //  >>  LAST
                                    if (!$last) {
                                        $plus = $page + 1;
                                        echo "<li>";
                                        echo "<a href='news_magazine.php?page=$plus'>>></a>";
                                        echo "</li>";
                                        echo "<li>";
                                        echo " <a href='news_magazine.php?page=$rel'>Last</a>";
                                        echo "</li>";
                                    }
                                }
                                ?>
