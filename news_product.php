    ...
    <body class="nav-md">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><?= $_SESSION["info"] ?>News Magazine</small></h2>
                                        ...
                                        <div class="x_content">
                                            <a href="news_magazine_manage.php?func=add">
        ...
        <script  type="text/javascript">
            ...
            function initialDataTable(first) {
                ...
                $.ajax({
                    type: 'GET',
                    url: 'controller/newsController.php?func=dataTable&type=P',
                    //data: Jsdata,
                    beforeSend: function ()
                    {
//                        $('#se-pre-con').fadeIn(100);
                    ...
                    success: function (data) {
                        ...
                        $.each(res, function (i, item) {
                            ...
                            col_edit = '<a href="./press_manage.php?func=edit&seq_i=' + item.s_path_img + '" >';
