...
<div class="yoo-zoo macchine-uikit macchine-uikit-medicali">
	...
	<div class="sfondo-grigio">
		...
		<h1 class="uk-text-left">Medical</h1></div>
...
<h3 class="uk-margin-remove">
	 <div class="logo">
	 <a href="devices_item.php?id=<?= $_data[$key]['id']; ?>" title="<?= $_data[$key]['s_devices_' . $_SESSION["main_lan"]]; ?>">
...
<li class="element element-itemlink">
	 <a href="devices_item.php?id=<?= $_data[$key]['id']; ?>">Show details</a></li></ul>
</div>
</div>
                                    <?php
                                }
