...
ACTIVEPAGES(9);
ACTIVEPAGES_SUB(9, 2);
if ($_GET["func"] == NULL || $_GET["type"] == NULL) {
    header('Location: ui_index.php');
}
if ($_GET["type"] == "top") {
    $pageTxt = "top";
    $imgPath = "../../images/top_content/";
} else if ($_GET["type"] == "bottom") {
    $pageTxt = "bottom";
    $imgPath = "../../images/bottom_content/";
}
?>
<html lang="en">
    <head>
                                    ...
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <?php if ($_GET["func"] == "edit") { ?>
                                                <h2><?= $_SESSION["edit_info"] ?> <?= $_SESSION["_" . $pageTxt . "_content"] ?></small></h2>
                                            <?php } else { ?>
                                                <h2><?= $_SESSION["add"] ?> <?= $_SESSION["_" . $pageTxt . "_content"] ?></small></h2>
                                            <?php } ?>
                                            ...
                                            if ($_GET["func"] == "edit") {
                                                ...
                                                foreach ($_data as $key => $value) {
                                                    ...
                                                    <form id="form_edit" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                        <input type="hidden" name="s_type" id="s_type" value="<?= $pageTxt ?>">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >
                                                                <?= $_SESSION["col_index_topic_th"] ?>
                                                                <span class="required">*</span>
                                                            </label>
                                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                                <input type="text" id="s_topic_th" name="s_topic_th"  class="form-control col-md-3 col-xs-3" value="<?= $_data[$key]['s_topic_th'] ?>" >
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >
                                                                <?= $_SESSION["col_index_topic_en"] ?>
                                                                <span class="required">*</span>
                                                            </label>
                                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                                <input type="text" id="s_topic_en" name="s_topic_en"  class="form-control col-md-3 col-xs-3" value="<?= $_data[$key]['s_topic_en'] ?>" >
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >
                                                                <?= $_SESSION["col_index_index"] ?>
                                                                <span class="required">*</span>
                                                            </label>
                                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                                <input type="number" id="index" name="index"  class="form-control col-md-3 col-xs-3" value="<?= $_data[$key]['i_index'] ?>" min="0">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >
                                                                <?= $_SESSION["col_index_url"] ?>
                                                                <span class="required">*</span>
                                                            </label>
                                                            <div class="col-md-3 col-sm-3 col-xs-12">
                                                                <input type="text" id="s_url" name="s_url"  class="form-control col-md-3 col-xs-3" value="<?= $_data[$key]['s_url'] ?>" >
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12"><?= $_SESSION["col_index_img"] ?> 
                                                            </label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >
                                                                <?= $_SESSION["col_index_detail_th"] ?>
                                                                <span class="required">*</span>
                                                            </label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <textarea class="form-control" name="detail_th" id="detail_th" ><?= $_data[$key]['s_detail_th'] ?></textarea>
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" >
                                                                <?= $_SESSION["col_index_detail_en"] ?>
                                                                <span class="required">*</span>
                                                            </label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <textarea class="form-control" name="detail_en" id="detail_en" ><?= $_data[$key]['s_detail_en'] ?></textarea>
                                                            </div>
                                                        </div>
                                                ...
                                                <form data-parsley-validate class="form-horizontal form-label-left" 
                                                      enctype="multipart/form-data" name="form_add" id="form_add" method="post" >
                                                    <input type="hidden" name="s_type" id="s_type" value="<?= $pageTxt ?>">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >
                                                            <?= $_SESSION["col_index_topic_th"] ?>
                                                        ...
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <input type="text" id="s_topic_th" name="s_topic_th"  class="form-control col-md-3 col-xs-3" value="" min="0">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >
                                                        ...
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <input type="text" id="s_topic_en" name="s_topic_en"  class="form-control col-md-3 col-xs-3" value="" min="0">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                                            <input type="text" id="s_url" name="s_url"  class="form-control col-md-3 col-xs-3" value="" min="0">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"><?= $_SESSION["col_index_img"] ?><span class="required">*</span>
                                                        </label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#form_edit").submit(function (e) {
                ...
                formData.append("func", "update_index");//seq
            ...
            $("#form_add").submit(function (e) {
                ...
                e.preventDefault();
                var formData = new FormData($(this)[0]);
                formData.append("func", "add_index");//seq 
                console.log($(this).serialize());
                $.ajax({
                    type: 'POST',
                    url: 'controller/contentController.php',
    ...
    <div class="modal fade boxError" id="err-dialog"  Style="width: 550px;height: 64px ;    overflow: hidden;">
