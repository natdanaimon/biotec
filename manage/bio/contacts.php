                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="x_panel">
                                        ...
                                        <div class="x_title">
                                            ...
                                            <h2><?= $_SESSION["info"] ?><?= $_SESSION["contacts"] ?></small></h2>
                                            ...
                                            <table id="datatable-checkbox" class="table table-striped table-bordered">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th > <?= $_SESSION["tb_col_status"] ?> </th>

                                                        <th><?= $_SESSION["tb_col_date"] ?></th>

                                                        <th><?= $_SESSION["tb_col_subject"] ?></th>

                                                        <th><?= $_SESSION["tb_col_name"] ?></th>

<!--                                                        <th style="width: 120px;"><?= $_SESSION["tb_col_phone"] ?></th>

                                                        <th style="width: 200px;"><?= $_SESSION["tb_col_email"] ?></th>-->



                                                        <th style="width: 90px;"><?= $_SESSION["tb_col_detail"] ?></th>
        ...
        <script  type="text/javascript">
            ...
            function initialDataTable(first) {
                ...
                $.ajax({
                    type: 'GET',
                    url: 'controller/contactsController.php?func=dataTable',
                    //data: Jsdata,
...
//                                col_email,
        ...
        <?php
        $element = array(
            array("i_seq", "innerHTML"),
            array("fullname", "innerHTML"),
            array("tel", "innerHTML"),
            array("email", "innerHTML"),
            array("city", "innerHTML"),
            array("country", "innerHTML"),
            array("subject", "innerHTML"),
            array("message", "innerHTML"),
            array("dateTime", "innerHTML")
        );

        $util->AddAjaxGetResultResponseText("contactsViewEmail", $element, "controller/contactsController.php", "modalViewEmail", TRUE);
        ?>
        ...
        <div id="modalViewEmail" class="modal " tabindex="-1" role="dialog" style=" overflow: hidden !important;" >
            ...
            <div class="modal-dialog modal-lg" >
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div Style="width:360px !important;  word-wrap: break-word;">
                            <h4 id="subject" name="subject"></h4>
                        </div>
                        <br/>

                        <div Style="width:360px !important;  word-wrap: break-word;">
                            <div class="header-content"><?= $_SESSION["tb_col_detail"] ?></div>
                            <div >
                        ...
                        <br/>
                        <br/>
                        <div class="header-content"><?= $_SESSION["contacts_info"] ?></div>
                        ...
                        <h6 id="email" name="email"/>

                        <br/>

                        <h6 id="city" name="city"/> 

                        <br/>

                        <h6 id="country" name="country"/>
