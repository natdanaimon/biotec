...
//                        $('#se-pre-con').fadeIn(100);
        ...
        <div id="modalViewEmail" class="modal " tabindex="-1" role="dialog" >
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title ">
                            <div class="col-md-1 col-sm-1 col-xs-1 form-group left ">
                                <img src="images/email.png" height="40px" width="40px"/>

                            </div>
                            <div class="col-md-10 col-sm-10 col-xs-10 form-group left ">
