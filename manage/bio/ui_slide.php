    ...
    <body class="nav-md">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="col-xs-3">
                                        ...
                                        <ul class="nav nav-tabs tabs-left">
                                            <li class="active"><a href="#home" data-toggle="tab" aria-expanded="true"><?= $_SESSION["tab_index"] ?></a>
                                            </li>
                                            <li class=""><a href="#about" data-toggle="tab" aria-expanded="false"><?= $_SESSION["tab_about"] ?></a>
                                            </li>
                                            <li class=""><a href="#contacts" data-toggle="tab" aria-expanded="false"><?= $_SESSION["tab_contacts"] ?></a>
                                            </li>
                                    ...
                                    <div class="col-xs-9">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="home">
                                                ...
                                                <a href="ui_slide_manage.php?func=add&page=1">
                                                    <button type="button" class="btn btn-primary"><?= $_SESSION["btn_create_for_home"] ?>
                                                    </button>
                                                </a>
                                                ...
                                                <table id="datatable-checkbox1" class="table table-striped table-bordered" style="width: 100%;">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style=""><?= $_SESSION["col_slide_img"] ?></th>
                                                            <th style=""><?= $_SESSION["col_slide_index"] ?></th>
                                                            <th style=""><?= $_SESSION["col_slide_status"] ?></th>
                                                            <th style=""> <?= $_SESSION["col_slide_edit"] ?> </th>
                                                            <th style=""><?= $_SESSION["col_slide_delete"] ?></th>
                                                        </tr>
                                            ...
                                            <div class="tab-pane" id="about">
                                                <a href="ui_slide_manage.php?func=add&page=2">
                                                    <button type="button" class="btn btn-primary"><?= $_SESSION["btn_create_for_about"] ?>
                                                    </button>
                                                </a>
                                            ...
                                            <div class="tab-pane" id="contacts">
                                                <a href="ui_slide_manage.php?func=add&page=3">
                                                    <button type="button" class="btn btn-primary"><?= $_SESSION["btn_create_for_contacts"] ?>
                                                    </button>
                                                </a>
                                                <table id="datatable-checkbox3" class="table table-striped table-bordered" style="width: 100%;">
                                                    <thead>
                                                        <tr>
        ...
        <script  type="text/javascript">
            ...
            function initialDataTable(first) {
                ...
                $.ajax({
                    type: 'GET',
                    url: 'controller/slideController.php?func=dataTable&page=index',
                    //data: Jsdata,
                    beforeSend: function ()
                    {
//                        $('#se-pre-con').fadeIn(100);
                    ...
                    success: function (data) {
                        ...
                        $.each(res, function (i, item) {
                            ...
                            col_img += '<a href="javascript:previewImage(\'../../images/slideshow/homepage/' + item.s_img + '\');">';
                            col_img += '<img  src="../../images/slideshow/homepage/' + item.s_img + '"  width="100px" height="50px" />';
                            ...
                            col_edit = '<a href="./ui_slide_manage.php?func=edit&page=1&seq_i=' + item.i_seq + '" >';
                            col_edit += '<img src="images/edit.png" width="30px" height="30px" />';
                            col_edit += '</a>';
                            col_delete = '<a href="javascript:slideConfirm(\'' + item.i_seq + '\',\'' + item.s_img + '\',\'' + item.s_page + '\');">';
                ...
                function tb2() {
                    $.ajax({
                        type: 'GET',
                        url: 'controller/slideController.php?func=dataTable&page=about',
                        //data: Jsdata,
                        beforeSend: function ()
                        {
//                        $('#se-pre-con').fadeIn(100);
                        ...
                        success: function (data) {
                            ...
                            $.each(res, function (i, item) {
                                ...
                                col_img += '<a href="javascript:previewImage(\'../../images/slideshow/chisiamo/' + item.s_img + '\');">';
                                col_img += '<img  src="../../images/slideshow/chisiamo/' + item.s_img + '"  width="100px" height="50px" />';
                                col_img += '</a> <span>' + item.s_img + '</span>';
                                ...
                                col_edit = '<a href="./ui_slide_manage.php?func=edit&page=2&seq_i=' + item.i_seq + '" >';
                                col_edit += '<img src="images/edit.png" width="30px" height="30px" />';
                                col_edit += '</a>';
                                col_delete = '<a href="javascript:slideConfirm(\'' + item.i_seq + '\',\'' + item.s_img + '\',\'' + item.s_page + '\');">';
                                col_delete += '<img  src="images/delete.png"  width="30px" height="30px" />';
                ...
                function tb3() {
                    $.ajax({
                        type: 'GET',
                        url: 'controller/slideController.php?func=dataTable&page=contacts',
                        //data: Jsdata,
                        beforeSend: function ()
                        {
//                        $('#se-pre-con').fadeIn(100);
                        ...
                        success: function (data) {
                            var language = '<?= $_SESSION["lan"] ?>';
                            if (data == '') {
                                var datatable = $datatable3.dataTable().api();
                                $('.dataTables_empty').remove();
                                datatable.clear();
                                datatable.draw();
                            }
                            ...
                            $.each(res, function (i, item) {
                                ...
                                col_img += '<a href="javascript:previewImage(\'../../images/slideshow/contacts/' + item.s_img + '\');">';
                                col_img += '<img  src="../../images/slideshow/contacts/' + item.s_img + '"  width="100px" height="50px" />';
                                col_img += '</a> <span>' + item.s_img + '</span>';
                                ...
                                col_edit = '<a href="./ui_slide_manage.php?func=edit&page=3&seq_i=' + item.i_seq + '" >';
                                col_edit += '<img src="images/edit.png" width="30px" height="30px" />';
                                col_edit += '</a>';
                                col_delete = '<a href="javascript:slideConfirm(\'' + item.i_seq + '\',\'' + item.s_img + '\',\'' + item.s_page + '\');">';
                                col_delete += '<img  src="images/delete.png"  width="30px" height="30px" />';
            ...
            function slideConfirm(seq, img, page) {
                $('#tmp_seq').val(seq);
                $('#tmp_img').val(img);
                $('#tmp_page').val(page);
            ...
            function slideDelete() {
                ...
                $.ajax({
                    type: 'GET',
                    url: 'controller/slideController.php?func=delete&seq=' + seq + '&img=' + img + '&page=' + page,
                    beforeSend: function ()
                    {
                        $('#se-pre-con').fadeIn(100);
                    },
        ...
        <div class="modal fade boxConfirmDelete" id="confirm-dialog"  Style="width: 330px;height: 135px">
            ...
            <input type="hidden" name="tmp_page" id="tmp_page"/>
            <p id="confirm-code" class="f-white"><?= $_SESSION["confirmDelete"] ?></p>  
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btnConfirm" onclick="slideDelete()"><?= $_SESSION["btn_confirm"] ?></button>
            </div>
        </div>
        <!--  Fix Custom Alert POPUP-->
