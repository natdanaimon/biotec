                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            ...
                                            <?php } else { ?>
                                                <h2><?= $_SESSION["press_add"] ?> <?= $_SESSION["info"] ?><?= $_SESSION["press"] ?></small></h2>
                                            <?php } ?>
        ...
        <script>
           ...
           //alert($('input[name=status]:checked', '#form_add').val());
            ...
            $(document).ready(function () {
                   ...
                   $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (res[0] == "0000") {
                                ...
                                $('#success-dialog').modal('show').on('show.bs.modal', function () { 
                                        location.reload();
                                  });
                                                    //           location.reload();
                ...
                function pressAdd() {
                    alert("test");
                    var sub_th = $('#subject_th').val();
                    var sub_en = $('#subject_en').val();
                    var date_ = $('#single_cal1').val();
                    var status = $('input[name=status]:checked', '#form_add').val();
                    ...
                    /*$.ajax({
                     type: 'GET',
                     url: 'controller/pressController.php?func=delete&seq=30',
                     //data: Jsdata,
                     beforeSend: function ()
                     {
                     $('#se-pre-con').fadeIn(100);
                ...
                /* $("form").submit(function(){
                 //alert($('input[name=status]:checked', '#demo-form2').val());
                 //alert("Submitted");
                 //alert($("#uploadPic").val());
                 var file_data = $('#uploadPic').prop('files')[0];   
                 var file_data = $('input[name=status]:checked', '#demo-form2').val().prop('test')[1]; 
                 ...
                 processData: false,
                 data: form_data, 
                 //status: $('input[name=status]:checked', '#demo-form2').val(), 
                 type: 'post',
