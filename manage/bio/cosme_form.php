	...
	<tr>
		...
		<br />
			<span id="show_image"></span>
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <input type="file" id="main_img" name="main_img" required="required" class="form-control col-md-7 col-xs-12">
                                                        </div>
                                                    </div>
	...
	<tr>
		...
		<br />
			<span id="show_logo"></span>
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <input type="file" id="main_logo" name="main_logo" required="required" class="form-control col-md-7 col-xs-12">
                                                        </div>
                                                    </div>
