...
if ($_GET["func"] == "edit" && $_GET["seq_i"] == NULL) {
    echo header("Location: news_magazine.php");
}
?>
                    ...
                    <div class="">
                        ...
                        <div class="page-title">
                            ...
                            <div class="title_left">
                                ...
                                <h3><?= $_SESSION["news"] ?>  <?= $_SESSION["magazine"] ?> </h3>
                                                ...
                                                foreach ($_data as $key => $value) {
                                                    ...
                                                    <form data-parsley-validate class="form-horizontal form-label-left" 
                                                        ...
                                                        <div style="visibility:hidden;">
                                                            ...
                                                            <input type="text"name="curent_pic" id="curent_pic" value="<?= $_data[$key]["s_path_img"] ?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <input type="text" id="subject_th" name="subject_th" value="<?= $_data[$key]['s_subject_th'] ?>"
...
<script  type="text/javascript">
    ...
    function newsDelete(seq) {
        ...
        $.ajax({
            type: 'GET',
            url: 'controller/newsController.php?func=delete&seq=' + seq,
            //data: Jsdata,
