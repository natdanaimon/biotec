    ...
    <body class="nav-md">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2><?= $_SESSION["info"] ?><?= $_SESSION["our_customers"] ?></small></h2>
                                        ...
                                        <div class="x_content">
                                            <a href="customers_manage.php?func=add">
                                                <button type="submit" class="btn btn-primary"><?= $_SESSION["add"] ?>
                                                </button>
                                            </a>
                                            <table id="datatable-checkbox" class="table table-striped table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 150px;" ><?= $_SESSION["tb_customer_col_name_th"] ?></th>
                                                        <th style="width: 150px;"><?= $_SESSION["tb_customer_col_name_en"] ?></th>
                                                        <th style="width: 150px;"><?= $_SESSION["tb_customer_col_url"] ?></th>
                                                        <th style="width: 50px;"><?= $_SESSION["tb_customer_col_img"] ?></th>
                                                        <th style="width: 50px;"><?= $_SESSION["tb_customer_col_status"] ?></th>
                                                        <th style="width: 40px;"><?= $_SESSION["tb_customer_col_edit"] ?></th>
                                                        <th style="width: 40px;"><?= $_SESSION["tb_customer_col_delete"] ?></th>
                                                    </tr>
        ...
        <script  type="text/javascript">
            ...
            function initialDataTable(first) {
                ...
                $.ajax({
                    type: 'GET',
                    url: 'controller/customersController.php?func=dataTable',
                    //data: Jsdata,
                    beforeSend: function ()
                    {
//                        $('#se-pre-con').fadeIn(100);
                    ...
                    success: function (data) {
                        ...
                        $.each(res, function (i, item) {
                            ...
                            col_name_th = item.s_name_th;
                            col_name_en = item.s_name_en;
                            col_url = item.s_url;
                            ...
                            col_edit = '<a href="./customers_manage.php?func=edit&seq_i=' + item.i_seq + '" >';
                            col_edit += '<img src="images/edit.png" width="30px" height="30px" />';
                            col_edit += '</a>';
                            debugger;
                            col_delete = '<a href="javascript:customersConfirm(' + item.i_seq + ',\'' + item.s_img + '\');">';
            ...
            function customersConfirm(seq, img) {
                $('#tmp_seq').val(seq);
                $('#tmp_img').val(img);
            ...
            function customersDelete() {
                ...
                $.ajax({
                    type: 'GET',
                    url: 'controller/customersController.php?func=delete&seq=' + seq + '&file=' + img ,
                    //data: Jsdata,
                    beforeSend: function ()
                    {
                        $('#se-pre-con').fadeIn(100);
        ...
        <div class="modal fade boxConfirmDelete" id="confirm-dialog"  Style="width: 330px;height: 135px">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btnConfirm" onclick="customersDelete()"><?= $_SESSION["btn_confirm"] ?></button>
            </div>
        </div>
        <!--  Fix Custom Alert POPUP-->
